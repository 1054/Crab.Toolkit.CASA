...
PLOTBANDPASS_REVISION_STRING = "$Id: plotbandpass3.py,v 1.201 2020/02/24 21:44:45 thunter Exp $" 
import pylab as pb
...
def version(showfile=True):
    ...
    """
    myversion = "$Id: plotbandpass3.py,v 1.201 2020/02/24 21:44:45 thunter Exp $" 
    if (showfile):
