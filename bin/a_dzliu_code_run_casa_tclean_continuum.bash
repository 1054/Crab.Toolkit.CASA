...
usage() {
    echo "Usage:"
    echo "    ./a_dzliu_code_run_casa_tclean_continuum.bash -vis your_input_vis.ms -out your_output_prefix"
    echo "Notes:"
...
CASA_COMMANDLINE_OVERWRITE="False"
iarg=1
argstr=""
argmode="none"
while [[ $iarg -le $# ]]; do
    ...
    case "$argstr" in
        ...
        -target|-field)
            ...
            ;;
        -overwrite)
            argmode="none"; CASA_COMMANDLINE_OVERWRITE="True"
            ;;
        -*)
...
export CASA_COMMANDLINE_OVERWRITE
export CASA_COMMANDLINE_SYSPATH=$(dirname "$script_dir")/lib/python
#exit
