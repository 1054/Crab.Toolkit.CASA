...
# -*- coding: utf-8 -*-
"""
A Python command line script by Daizhong Liu to linear mosaick FITS images/cubes.

If inputting cubes, they must have the same number of channels.
"""
# 
...
Input_files = glob.glob('Level_4_Data_Images_Divide_Mosaic/DataSet_Merged_Mosaic_*/output_*_clean.image.pbcor.fits')
...
# Loop input images and find common area
list_of_regions = []
